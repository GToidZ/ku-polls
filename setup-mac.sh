...
curl -L "https://github.com/stedolan/jq/releases/download/jq-1.5/jq-osx-amd64" -o ./jq > /dev/null 2>&1;
...
if [ $TEST_STATUS -ge 1 ]; then
    ...
    echo echo ". ./.venv/bin/activate && $PYTHON ./manage.py runserver 8000"
fi
